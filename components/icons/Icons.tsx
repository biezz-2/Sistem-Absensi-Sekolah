...
export const QrCodeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v1m6 11h2m-6.5 6.5v-2.5m-2.5 2.5h-2.5m-2.5-2.5v-2.5m-2.5 2.5h-2.5M12 4h1m5 11h1M12 4h1m-1 11h1m-1-5h1m-1 5v1m0-6h1m-1 5v1m0-6h1m-1 5v1m-5-5h1m-1 5v1M7 9h1m-1 5v1m-1-5h1m0 5v1M7 9h1m0 5v1M7 9h1" />
    </Icon>
);
